...
CREATE TABLE EKO.SCHOOL (
    ID BIGINT DEFAULT (NEXT VALUE FOR EKO.SEQ_SCHOOL_ID) PRIMARY KEY NOT NULL,
    NAME NVARCHAR(MAX),
...
CREATE TABLE EKO.USER (
    ...
    SCHOOL_ID BIGINT CONSTRAINT FK_USER_SCHOOL
    );
...
CREATE TABLE EKO.ALERT (
    ID BIGINT DEFAULT (NEXT VALUE FOR EKO.SEQ_ALERT_ID) PRIMARY KEY NOT NULL,
